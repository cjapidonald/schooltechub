...
UPDATE public.content_master 
  SET subject = CASE
    WHEN subject IN ('English/ELA', 'Grammar', 'Reading', 'Writing', 'Spelling', 'Vocabulary') THEN 'English'
    WHEN subject = 'STEM' THEN 'STEAM'
    ELSE subject
  END
WHERE subject IN ('English/ELA', 'Grammar', 'Reading', 'Writing', 'Spelling', 'Vocabulary', 'STEM');
