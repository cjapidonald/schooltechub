...
ALTER TABLE public.content_master 
  ADD COLUMN filter_type public.filter_type_enum,
  ADD COLUMN platform public.platform_enum;
...
ALTER TABLE public.newsletter_subscribers 
  ...
  ADD COLUMN role public.user_role_enum;
...
CREATE INDEX idx_content_master_filter_type ON public.content_master(filter_type);
CREATE INDEX idx_content_master_platform ON public.content_master(platform);