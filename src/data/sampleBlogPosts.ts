...
export const SAMPLE_BLOG_POSTS: SampleBlogPost[] = [
  {
    ...
    is_published: true,
    is_pinned: false,
    meta_title: "How an AI Co-Teacher Personalizes Every Classroom | SchoolTech",
    meta_description: "Discover how Ms. Saunders uses an AI planning assistant to map out weekly lessons, surface intervention groups, and keep families in the loop.",
    read_time: 8,
  ...
  },
  {
    ...
    is_published: true,
    is_pinned: true,
    meta_title: "Designing Virtual Reality Field Trips for Primary Classrooms | SchoolTech",
    meta_description: "Step-by-step guidance for building immersive explorations that fit a 40-minute block.",
    read_time: 6,
  ...
  },
  {
    ...
    is_published: true,
    is_pinned: false,
    meta_title: "Building a Family Portal for Project-Based Learning | SchoolTech",
    meta_description: "Follow a middle school team that launched a secure family portal to document PBL milestones, celebrate wins, and streamline conferencing.",
    read_time: 9,
  ...
  },
  {
    ...
    is_published: true,
    is_pinned: true,
    meta_title: "Maker Labs Meet State Standards | SchoolTech",
    meta_description: "A guide to aligning rapid-prototype STEM labs with accountability expectations.",
    read_time: 5,
  ...
  },
  {
    ...
    is_published: true,
    is_pinned: false,
    meta_title: "Leading Student AI Ethics Roundtables | SchoolTech",
    meta_description: "Protocols for future-ready discussions in secondary classrooms.",
    read_time: 7,
