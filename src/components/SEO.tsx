...
export function SEO({
  title,
  description,
  keywords = "AI education, EdTech, virtual reality learning, gamification, teacher management software, student tracking, educational technology, classroom management, online learning platform",
  image = "/og-image.jpg",
