...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl border-2 border-primary/40 bg-background/80 p-1 text-muted-foreground shadow-[0_0_18px_hsl(var(--glow-primary)/0.1)] backdrop-blur-sm",
      className,
    )}
    {...props}
  />
