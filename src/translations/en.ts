  ...
  dashboard: {
    ...
    students: {
      ...
      filters: {
        ...
        searchLabel: "Search",
        searchPlaceholder: "Search students, classes, or notes",
        ...
        sortStageAsc: "Stage A → Z",
        sortStageDesc: "Stage Z → A",
        clear: "Clear filters",
      },
      actions: {
        add: "Add students",
      ...
      labels: {
        ...
        unknownSubject: "No subject set",
        unknownStage: "No stage set",
      },
      empty: "No students to show yet. Add your roster to get started.",
      emptyFiltered: "No students match your filters yet. Try adjusting your search or reset the filters.",
      metrics: {
        totalLabel: "Students total",
        visibleLabel: "Students shown",
        classesLabel: "Classes represented",
        filters: "{count} filters active",
      },
      dialog: {
        title: "Add students",
