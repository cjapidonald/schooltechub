...
export type ContentMasterRow = {
  ...
  billing: PublicEnums["billing_enum"] | null;
  bloom_level: PublicEnums["bloom_enum"] | null;
  ...
  event_status: PublicEnums["event_status_enum"] | null;
  event_timezone: string | null;
  event_type: PublicEnums["event_type_enum"] | null;
  excerpt: string | null;
  /** Pre-rendered FAQ entries associated with this content. */
  faq_json: Json | null;
  ...
  language_level: PublicEnums["language_level_enum"] | null;
  ...
  resource_type: PublicEnums["resource_type_enum"] | null;
  service_model: PublicEnums["service_model_enum"] | null;
  sla_tier: PublicEnums["sla_tier_enum"] | null;
  slug: string;
  ...
  tags: string[] | null;
  /** Highlighted testimonials stored inline for quick rendering. */
